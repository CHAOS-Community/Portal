...
namespace CHAOS.Portal.Modules.Test
{
    ...
    public class SubscriptionModuleTest : TestBase
    {
        ...
        public new void SetUp()
        {
            ...
            SubscriptionModule.Initialize( string.Format( "<Settings ConnectionString=\"{0}\" />", ConfigurationManager.ConnectionStrings["PortalEntities"].ConnectionString.Replace("\"", "&quot;") ) );
        }
