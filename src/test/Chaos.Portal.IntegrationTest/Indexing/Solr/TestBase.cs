namespace Chaos.Portal.IntegrationTest.Indexing.Solr
{
    ...
    public class TestBase
    {
        ...
        public void SetUp()
        {
            ...
            _httpConnection.Post("update", XElement.Parse("<add><doc><field name=\"Guid\">" + ResultOne + "</field></doc><doc><field name=\"Guid\">" + ResultTwo + "</field></doc><doc><field name=\"Guid\">" + ResultThree + "</field></doc></add>")).Dispose();
