...
namespace CHAOS.Portal.Core.Test
{
    ...
    public class ParameterBindingsTest : TestBase
    {
        ...
        {
            CallContext.PortalRequest.Parameters.Add( "test", "string value" );
            ParameterInfo parameterInfo = typeof(MockExtension).GetMethod("TestStringParameter").GetParameters()[1];

            Assert.AreEqual( "string value", PortalApplication.Bindings.Bindings[typeof(string)].Bind( CallContext, parameterInfo ) );
        }

        [Test]
        public void Should_Should_Bind_Null_String_Parameter()
        {
            CallContext.PortalRequest.Parameters.Add( "test", null );
            ParameterInfo parameterInfo = typeof(MockExtension).GetMethod("TestStringParameter").GetParameters()[1];

            Assert.AreEqual( null, PortalApplication.Bindings.Bindings[typeof(string)].Bind( CallContext, parameterInfo) );
        }

        [Test]
        public void Should_Should_Bind_Int32_Parameter()
        {
            CallContext.PortalRequest.Parameters.Add( "test", "1000" );
            ParameterInfo parameterInfo = typeof(MockExtension).GetMethod("TestInt32Parameter").GetParameters()[1];

            Assert.AreEqual( 1000, PortalApplication.Bindings.Bindings[typeof(int)].Bind( CallContext, parameterInfo) );
        }
        ...
        public void Should_Should_Throw_ParameterBindingMissingException_If_Int32_Parameter_Is_Missing()
        {
            ...
            PortalApplication.Bindings.Bindings[typeof(int)].Bind( CallContext, parameterInfo );
        }
        ...
        public void Should_Should_Bind_Null_Int32_Parameter()
        {
            ...
            Assert.AreEqual( null, PortalApplication.Bindings.Bindings[typeof(int)].Bind( CallContext, parameterInfo ) );
        }
        ...
        public void Should_Should_Bind_UInt32_Parameter()
        {
            ...
            Assert.AreEqual( 1000, PortalApplication.Bindings.Bindings[typeof(uint)].Bind( CallContext, parameterInfo) );
        }
        ...
        public void Should_Should_Bind_Null_UInt32_Parameter()
        {
            ...
            Assert.AreEqual( null, PortalApplication.Bindings.Bindings[typeof(uint)].Bind( CallContext, parameterInfo ) );
        }

        [Test]
        public void Should_Should_Bind_UUID_Parameter()
        {
            CallContext.PortalRequest.Parameters.Add( "test", "21ec2020-3aea-1069-a2dd-08002b30309d" );
            ParameterInfo parameterInfo = typeof(MockExtension).GetMethod("TestUUIDParameter").GetParameters()[1];

            Assert.AreEqual( "21ec2020-3aea-1069-a2dd-08002b30309d", PortalApplication.Bindings.Bindings[typeof(UUID)].Bind( CallContext, parameterInfo).ToString() );
        }
        ...
        public void Should_Should_Bind_Null_UUID_Parameter()
        {
            ...
            Assert.AreEqual( null, PortalApplication.Bindings.Bindings[typeof(UUID)].Bind( CallContext, parameterInfo ) );
        }
    }
}
