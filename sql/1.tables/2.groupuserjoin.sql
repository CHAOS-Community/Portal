...
(
	...
	CONSTRAINT  FK_Group_User_Join_GroupGUID_Group_GUID  FOREIGN KEY ( GroupGUID ) REFERENCES  `Group`  ( GUID ),
	CONSTRAINT  FK_Group_User_Join_UserGUID_User_GUID  FOREIGN KEY ( UserGUID ) REFERENCES  User  ( GUID )
) 
ENGINE=InnoDB