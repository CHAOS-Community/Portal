...
(
	...
	CONSTRAINT  FK_Subscription_User_Join_SubscriptionGUID_Subscription_GUID  FOREIGN KEY ( SubscriptionGUID ) REFERENCES  Subscription  ( GUID ),
	CONSTRAINT  FK_Subscription_User_Join_UserGUID_User_GUID  FOREIGN KEY ( UserGUID ) REFERENCES  User  ( GUID )
) 
ENGINE=InnoDB